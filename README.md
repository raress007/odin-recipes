...
Structuring HTML documents using semantic elements, creating and navigating between multiple pages with anchor links, working with ordered and unordered lists, embedding and styling images in HTML, organizing a project with a clean file/folder structure and setting up and managing a GitHub repository using Git.

Status:
🚧 Work in progress — styling with CSS coming in a future iteration.